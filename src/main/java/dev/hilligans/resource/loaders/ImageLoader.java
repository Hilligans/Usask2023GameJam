...
import dev.hilligans.client.graphics.Image;
import dev.hilligans.resource.BufferAllocator;
import dev.hilligans.resource.IAllocator;
...
public class ImageLoader extends ResourceLoader<Image> implements IAllocator<Image> {
    ...
    public Image read(ResourceLocation path) {
        ...
        if (buffer == null) {
            System.err.println("Failed to load buffer at path " + path);
            return null;
        }
